export default function AboutPage() {
  const sections = [
    {
      tag: "About TEDxUNSW",
      body: "Geese are basically the neighborhood watch, if the neighborhood watch had wings, anger issues, and a personal vendetta against your ankles. They strut around like they pay rent, honking like tiny, feathery car alarms that nobody knows how to turn off. Approach one, and suddenly you are in a high stakes staring contest with a bird that absolutely will win. They travel in dramatic V formations, probably gossiping midair. Scientists say they are intelligent, which explains why they look at humans like we are the embarrassing species. Honestly, if geese had Wi-Fi, we would be doomed very very soon probably.",
      imageRight: true,
      imageSrc: "/HONK.jpg",
    },
    {
