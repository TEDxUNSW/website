    ...
    <header>
      <div>
          ...
          <div className="flex flex-auto shrink-0">
            {/* <div className="flex flex-auto items-center font-helvetica text-2xl w-30 justify-end"> */}
              ...
              <button onClick={() => setIsOpen(!isOpen)} className="hover-bg-transparent pl-1">
                {isOpen ? <Close className="w-7 h-7 srinkg-0 grow-0"/> : <Hamburg className="shrink-0 grow-0" width={20}/> }
             </button>
            {/* </div> */}
          </div>
        </div>
        ...
        <div style={{ visibility: isOpen? 'visible' : 'hidden' }} 
          className="flex flex-col absolute right-0 z-50 bg-foreground text-background h-[82vh] w-40  justify-center items-center font-helvetica text-1xl font-bold">
